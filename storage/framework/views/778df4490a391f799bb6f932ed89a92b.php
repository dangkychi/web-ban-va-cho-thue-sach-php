...
<head>
    ...
    <!-- jsvectormap css -->
    <link href="<?php echo e(asset('backend/assets/libs/jsvectormap/css/jsvectormap.min.css')); ?>" rel="stylesheet"
    type="text/css" />
    
    <!--Swiper slider css-->
    <link href="<?php echo e(asset('backend/assets/libs/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div id="layout-wrapper">
        <?php echo $__env->make('admin.pages.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="main-content">
            ...
            <?php echo $__env->make('admin.pages.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- end main content-->
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="<?php echo e(asset('backend/assets/images/sidebar/img-1.jpg')); ?>" alt=""
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="<?php echo e(asset('backend/assets/images/sidebar/img-2.jpg')); ?>" alt=""
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="<?php echo e(asset('backend/assets/images/sidebar/img-3.jpg')); ?>" alt=""
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="<?php echo e(asset('backend/assets/images/sidebar/img-4.jpg')); ?>" alt=""
                                        class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                        </div>
    ...
    <!-- Vector map-->
    <script src="<?php echo e(asset('backend/assets/libs/jsvectormap/js/jsvectormap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/assets/libs/jsvectormap/maps/world-merc.js')); ?>"></script>
    ...
    <!-- prismjs plugin -->
    <script src="<?php echo e(asset('backend/assets/libs/prismjs/prism.js')); ?>"></script>

    <!-- nouisliderribute js -->
    <script src="<?php echo e(asset('backend/assets/libs/nouislider/nouislider.min.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/assets/libs/wnumb/wNumb.min.js')); ?>"></script>

    <!-- Jquery ui -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.13.2/jquery-ui.min.js" integrity="sha512-57oZ/vW8ANMjR/KQ6Be9v/+/h6bq9/l3f0Oc7vn6qMqyhvPd1cvKBRWWpzu0QoneImqr2SkmO4MSqU+RpHom3Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>

    <!-- my.js -->
    <script src="<?php echo e(asset('my.js')); ?>"></script>
...
<?php /**PATH D:\forproject\Nam3_Ky1\CNPM_NC\WebsiteBanVaMuonSach\websitebanvathuesach\resources\views/admin/layout/master.blade.php ENDPATH**/ ?>